...
amplitude_degrau = saida[-1] - saida[0]  # Amplitude do degrau de entrada
...
t_sim, y_modelo = ctrl.step_response(resposta_modelo, T=np.linspace(0, tempo[-1], num=len(tempo)))
...
print(f'Tempo de Atraso (theta): {theta:.4f} s')  # Alterado para 'theta'
print(f'Constante de Tempo (tau): {tau:.4f} s')  # Alterado para 'tau'
